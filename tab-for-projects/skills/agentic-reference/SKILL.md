...
description: "Structural patterns and conventions for writing Claude Code agents and skills — covers roles, workflows, constraints, triggers, and composition."
...
**When to activate:**
- The user runs `/agentic-reference`
- An agent is about to write or revise an agent or skill markdown file
- The user asks about conventions for writing agentic prompts, workflows, or tools

**When NOT to activate:**
- The user is editing application code, configs, or documentation
- The user wants MCP tool usage patterns — that's `/mcp-reference`
...
- The user wants prompt quality rules (that's /prompt-reference)
```
