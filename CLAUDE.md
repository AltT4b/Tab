...
tab-for-projects/                 # "tab-for-projects" plugin package
  ...
  agents/developer.md             #   Developer subagent — worktree-only; atomic on code + tests; never touches shared docs (CLAUDE.md, README, KB)
